...
Classify records and quantify who sets the partition.
...
- [`autoplot(`*`<ingrain_audit>`*`)`](https://kristianmiok.github.io/ingrain/reference/autoplot.ingrain_audit.md)
  : Plot an ingrain audit as a single partition bar
- [`autoplot(`*`<ingrain_profile>`*`)`](https://kristianmiok.github.io/ingrain/reference/autoplot.ingrain_profile.md)
  : Plot an ingrain profile as stacked shares across grains
- [`autoplot(`*`<ingrain_datasets>`*`)`](https://kristianmiok.github.io/ingrain/reference/autoplot.ingrain_datasets.md)
...
- [`crayfish`](https://kristianmiok.github.io/ingrain/reference/crayfish.md)
  : Crayfish occurrence records from GBIF (demonstration sample)

## Package

- [`ingrain-package`](https://kristianmiok.github.io/ingrain/reference/ingrain-package.md)
  : ingrain: Resolution-Relative Audit of Positional Uncertainty for
  Occurrence Records
- [`reexports`](https://kristianmiok.github.io/ingrain/reference/reexports.md)
  [`autoplot`](https://kristianmiok.github.io/ingrain/reference/reexports.md)
