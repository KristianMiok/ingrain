...
- Core classifier
  ...
  four-state resolution-relative partition (inert / marginal /
  actionable / unreported), boundary-exact to the cumulative-threshold
  construction used in the analysis pipeline, with
  [`print()`](https://rdrr.io/r/base/print.html) and
  [`summary()`](https://rdrr.io/r/base/summary.html) methods.
- [`ingrain_profile()`](https://kristianmiok.github.io/ingrain/reference/ingrain_profile.md):
  the partition across a sweep of grains, with an optional marked grain,
  sharing one internal classifier with
  [`ingrain()`](https://kristianmiok.github.io/ingrain/reference/ingrain.md)
